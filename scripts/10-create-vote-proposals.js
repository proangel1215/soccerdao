...
(async () => {  // create two proposals
            ...
            [
                {
                    ...
                    transactionData: tokenModule.contract.interface.encodeFunctionData(
                        // We're doing a mint! And, we're minting to the voteModule, which is acting as our treasruy.
                        "mint",
                        [
                            voteModule.address,
    ...
    try {
        ...
        console.error("failed to create the second proposal: ", err);
        process.exit(1);
    }
})();
